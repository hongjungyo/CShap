...
//Struct(구조제) : 하나의 이름으로 서로 다른 형식의 데이터를, 또는 함수들을 묶어서 관리하는 그릇 (데이터의 구조), 변수의 확장 
//[1] 구조체 정의, 선언 : 두개의 정수를 관리하는 구조체 만들기

struct Point
{
    public int x;   //public 키워드를 선언하여 외부에서 int x 변수를 사용 가능하도록 설정
    public int y;   //public 키워드를 선언하여 외부에서 int y 변수를 사용 가능하도록 설정
